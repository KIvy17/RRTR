...
class MainWindow(QMainWindow):
    ...
    def start_search(self):
        ...
        if modulation == "AM":
            if 520 < frequency < 570:
                message = f"Найдена ценная информация! Частота: {frequency} МГц, Модуляция: AM"
            else:
                message = "шшш..."
        elif modulation == "FM":
            if 920 < frequency < 970:
                message = f"Найдена ценная информация! Частота: {frequency} МГц, Модуляция: FM"
            else:
                message = "шшш..."
        else:  # ЧМ
            if 1320 < frequency < 1370:
                message = f"Найдена ценная информация! Частота: {frequency} МГц, Модуляция: ЧМ"
            else:
                message = "шшш..."
    ...
    def start_search_2(self):
        ...
        message = f"Найдена ценная информация! Частота: {frequency} МГц, Модуляция: {modulation}"
        self.message_edit.append(message)
